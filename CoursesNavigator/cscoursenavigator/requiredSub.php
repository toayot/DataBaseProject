...
<div class="main">
<div align="center";>
<FONT  COLOR=#000080 SIZE=6><B>รายวิชาที่จำเป็น</B></FONT></div>
<br>
<div align="right";>
<p >*หมายเหตุ : ever = เคยศึกษา,
pass = สอบได้,
or = หรือ,
and = และ</p></div>
<table>
...
$result = $conn->query("SELECT * FROM `subject` WHERE `semesterrequired` IS NOT NULL ORDER BY `subject`.`semesterrequired` ASC");
...
. $row["subName"]. "</td><td>" .($con1 . "  " . $opr . "  " . $con2). "</td></tr>";
}
echo "</table>";
} else { echo "0 results"; }
$conn->close();
